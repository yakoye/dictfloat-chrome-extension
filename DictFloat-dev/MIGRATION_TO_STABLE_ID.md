# Move to DictFloat v0.5.9 / Stable development ID
...
2. Load v0.5.9 from one permanent folder, such as `D:\work\chrome-extensions\DictFloat-dev`.
3. Open v0.5.9 Settings and click **Import backup**.
