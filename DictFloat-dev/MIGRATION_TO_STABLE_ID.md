# Move to DictFloat v0.5.8 / Stable development ID
...
2. Load v0.5.8 from one permanent folder, such as `D:\work\chrome-extensions\DictFloat-dev`.
3. Open v0.5.8 Settings and click **Import backup**.
