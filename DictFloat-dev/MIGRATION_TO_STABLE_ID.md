# Move to DictFloat v0.5.1 / Stable development ID
...
2. Load v0.5.1 from one permanent folder, such as `D:\work\chrome-extensions\DictFloat-dev`.
3. Open v0.5.1 Settings and click **Import backup**.
